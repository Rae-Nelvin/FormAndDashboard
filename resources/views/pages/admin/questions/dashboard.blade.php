...
@section('content')
            ...
            @if($question)
                ...
                <div class="flex flex-col h-auto justify-between w-full">
                    @foreach ($subSection as $subSections)
                        <h1 class="font-semibold text-xl mt-3">{{ $subSections->name }}</h1>
                    @endforeach
                    <div class="flex flex-col flex-nowrap justify-between space-y-[30px] mt-6 pl-[32px] pr-[120px] w-full">
                        @foreach ($question as $questions)
                            <form action="#" class="space-y-6 w-full">
                                <div class="w-full bg-white py-5 px-5 rounded-lg flex flex-col space-y-3">
