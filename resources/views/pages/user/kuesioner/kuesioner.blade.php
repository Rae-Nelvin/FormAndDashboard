    ...
    <div class="h-full w-full py-[71px] px-[33px] flex flex-col justify-between flex-nowrap items-start">
        <div class="mb-7">
            ...
            <div class="w-full mt-6 flex flex-col flex-nowrap space-y-[30px]">
                @if( ($subSection->id + 1) == ($upperLimit['subsectionID']) )
        ...
        <div>
            <div class="flex flex-row flex-nowrap space-x-[25px]">
                {{-- ($subSection->id - 1)  >= ($underLimit['subsectionID']) --}}
                @if ( 1 == 2 )
                    <a href="package/kuesioner/{{ $title->id }}/{{ $title->section->id }}/{{ $subSection->id - 1 }}">
                ...
                @elseif( ($subSection->id + 1) == ($upperLimit['subsectionID']) )
