  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 py-[25px] px-14 flex-none w-auto md:-ml-64 md:fixed md:top-0 md:z-30 md:h-full md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <div class="flex flex-col space-y-2">
        <a href="./index.html" class="flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-black hover:text-[#0060FF] hover:bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500">
