  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 py-[25px] px-14 flex-none w-auto md:-ml-64 md:fixed md:top-0 md:z-30 md:h-full md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <div class="flex flex-col space-y-2">
        <a href="{{ route('admin.renderDashboard') }}" class="{{ request()->is('admin/dashboard') ? 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-[#0060FF] bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' : 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-black hover:text-[#0060FF] hover:bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' }}">
        ...
        <!-- link -->
        <a href="{{ route('admin.renderJawaban') }}" class="{{ request()->is('admin/jawaban') ? 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-[#0060FF] bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' : 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-black hover:text-[#0060FF] hover:bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' }}">
        ...
        <!-- link -->
        <a href="{{ route('admin.renderPengguna') }}" class="{{ request()->is('admin/pengguna') ? 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-[#0060FF] bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' : 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-black hover:text-[#0060FF] hover:bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' }}">
        ...
        <!-- link -->
        <a href="{{ route('admin.renderAssign') }}" class="{{ request()->is('admin/assign') ? 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-[#0060FF] bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' : 'flex items-center text-lg py-[17px] px-9 rounded-lg font-medium text-black hover:text-[#0060FF] hover:bg-[#D5E6FB] focus:bg-[#D5E6FB] focus:text-[#0060FF] transition ease-in-out duration-500' }}">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" class="mr-[13px]">
              ...
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="py-6 px-8 text-center items-center flex flex-col">
                      ...
                      <div class="flex flex-row mt-8 space-x-[16px]">
                          <a data-modal-toggle="popup-modal-logout" href="#" type="button" class="text-white bg-[#E53535] hover:bg-[#ac2828] focus:ring-4 focus:outline-none focus:ring-red-300 font-normal rounded-full text-base inline-flex items-center px-[92px] py-5 text-center cursor-pointer transition-all duration-500 ease-in-out">
                              Keluar
                          </a>
